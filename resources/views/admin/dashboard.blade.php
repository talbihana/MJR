...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflara.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
...
td, th {
    ...
    padding: 15px;
    color: #ddd;
    border-bottom: 1px solid #81818149;
}
.circle-wrap {
    margin: 50px auto;
    width: 150px;
    ...
    <div id="main">
        <div class="head">
            ...
            <div class="col-div-6">
                ...
                <div class="profile">
                    <img src="images/user.jpeg" class="pro-img">
                <p>Hana<span></span></p>
                </div>
            </div>
