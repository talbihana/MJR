  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg   p-2">
      <div class="container-fluid text-white">
        ...
        <!-- //sidenavbar trigger -->
        <a
          class="navbar-brand text-uppercase fw-bold text-white me-auto"
          href="#"
          >RMG SOLUTIONS</a
        >
        <button
          ...
          <ul class="navbar-nav text-white">
            ...
            <li>
              ...
              >
                ...
                <span class="text-uppercase ms-2 active text-white">
                  interfaces
                </span>
                <i class="bi bi-chevron-down right-link ms-auto"></i>
              </a>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">Charts</div>
              <div class="card-body">
                <canvas class="chart" id="mychart" width="400" height="200">
                </canvas>
              </div>
            </div>
          </div>
